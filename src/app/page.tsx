			...
			<div className="m-3">
				<ContentOne
					...
					desc={[
						...
						`- <b>Địa chỉ:</b> <i>4.70 Tầng 4, Tòa nhà RiverGate, Số 151_155 Bến Vân Đồn, Phường 06, Quận 4, Thành phố Hồ Chí Minh, Việt Nam</i>. `,
					]}
				...
				<ContentTwo
					...
					desc={[
						`- <b>Sứ mệnh:</b> <span class='text-primary'>Aiking Investment</span> cam kết không ngừng nâng cao, chất lượng
				...
				<ContentOne
					...
					desc={[
						...
						`- <b>Trách nhiệm:</b> <span class='text-primary'>Aiking Investment</span> luôn đặt trách nhiệm lên hàng đầu với
						khách hàng, đối tác và toàn thể nhân viên.`,
						`- <b>Đoàn kết:</b> <span class='text-primary'>Aiking Investment</span> xây dựng một tập thể gắn kết mọi thành
						...
						`- <b>Con người:</b> <span class='text-primary'>Aiking Investment</span> xem nhân viên là nguồn tài sản quý giá
