              ...
              >
                ...
                <Bounce>
                  <p className="mb-12 text-base font-medium !leading-relaxed text-body-color dark:text-white dark:opacity-90 sm:text-lg md:text-xl">
                    BLOCK A, TÒA NHÀ RIVERGATE, 151-155 BẾN VÂN ĐỒN, PHƯỜNG 6,
                    QUẬN 4,TP.HCM
                  </p>
                </Bounce>
        ...
        <div className="absolute top-0 right-0 z-[-1] opacity-30 lg:opacity-100">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop offset="0.145833" stopColor="#ff5e57" stopOpacity="0" />
                <stop offset="1" stopColor="#ff5e57" stopOpacity="0.08" />
              </radialGradient>
              <radialGradient
